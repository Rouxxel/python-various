...
# GraphQL API Template - Development Startup Script

echo "🚀 GraphQL API Template - Development Setup"
echo "==========================================="
...
echo "📍 GraphQL Endpoint: http://localhost:${SERVER_PORT:-8000}/graphql"
echo "🔍 GraphiQL Interface: http://localhost:${SERVER_PORT:-8000}/graphql"
echo "❤️  Health Check: http://localhost:${SERVER_PORT:-8000}/health"